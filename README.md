...
```bash
protoc --go_out=. --go_opt=module=github.com/aman-zulfiqar/basic-go-grpc --go-grpc_out=. --go-grpc_opt=module=githu
b.com/aman-zulfiqar/basic-go-grpc proto/greet.proto
```
